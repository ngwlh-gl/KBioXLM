...
from run_uhc_data import DataCollatorForWWM_mlm_entity
...
def main():
    ...
    train_dataset, validation_dataset=ds_en['train'].train_test_split(test_size=0.01,seed=42).values()
    ...
    data_collator = DataCollatorForWWM_mlm_entity(tokenizer=tokenizer, mlm=True, mlm_probability=0.15, return_tensors="pt")
